...
/*
    ...
    public function display()
    {
        ...
        require_once('modules/'.$currentModule.'/license/VIFieldsColorOutfittersLicense.php');
        ...
        $key = VIFieldsColorOutfittersLicense::getKey($currentModule);
        if(!empty($key)) {
        ...
        $this->ss->display('modules/VIFieldsColorLicenseAddon/tpls/license.tpl');
    }//end of display
