...
',
  ...
  'LBL_LIVEHELPERCHAT' => 'Live Helper Chat License',
  'LBL_LIVEHELPERCHAT_LICENSE_TITLE' => 'License Configuration',
  'LBL_LIVEHELPERCHAT_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_FIELDS_COLOR' => 'Fields Color',
  'LBL_FIELDS_COLOR_DESCRIPTION' => 'Manage Fields Color for Modules.',
  'LBL_FIELDS_COLOR_LICENCE_ACTIVE_LABEL_MESSAGE' => 'VIFieldsColorLicenseAddon is no longer active due to the following reason:',
  'LBL_FIELDS_COLOR_LICENCE_ISSUES' => 'Users will have limited to no access until the issue has been addressed',
  'LBL_CLICK_HERE' => 'Click Here',
  'LBL_FIELDS_COLOR_RENEW_LICENCE_ACTIVE_MESSAGE' => 'VIFieldsColorLicenseAddon is no longer active',
  'LBL_FIELDS_COLOR_RENEW_LICENCE_MESSAGE' => 'Please renew your subscription or check your license configuration.',
  'LBL_UPDATE_LICENSE' => 'Update License',
  'LBL_CREATE_MESSAGE' => 'You currently have no records saved.',
  'LBL_CREATE' => 'CREATE',
  'LBL_CREATE_MESSAGE_ONE' => 'one now',
  'LBL_ADD_NEW' => '+ Add New',
  'LBL_FIELDS_TO_COLOR' => 'Fields To Color',
  ...
  'LBL_DELETE_CONFIRM_MESSAGE' => 'Are you sure want to delete',
  'LBL_THIS' => 'this',
  'LBL_THESE' => 'these',
  'LBL_ROW' => 'row?',
  'LBL_EDIT' => 'Edit',
  ...
  'LBL_APPLY_CONDITION' => 'Apply Condition',
  'LBL_NEXT' => 'Next',
  'LBL_NAME' => 'Name',
  'LBL_SELECT_AN_OPTION' => 'Select an Option',
  'LBL_SELECT_FIELDS_TO_COLOR' => 'Select Fields to Color',
  'LBL_TEXT_COLOR' => 'Text Color',
  'LBL_BACKGROUND_COLOR' => 'Background Color',
  'LBL_RELATED_RECORD_COLOR' => 'Relate Record Color',
  'LBL_COLOR_THE_LABEL' => 'Color the Label',
  'LBL_YES' => 'Yes',
  'LBL_NO' => 'No',
  'LBL_FIELDS_COLOR_ALL_CONDITIONS' => '<b>Option 1 : All Condition (AND Condition between each row of Condition) - </b>',
  'LBL_FIELDS_COLOR_ANY_CONDITIONS' => '<b>Option 2 : Any Condition (OR Condition between each row of Condition) - </b>',
  'LBL_FIELDS_COLOR_ALL_CONDITIONS_MESSAGE' => 'Specify conditions of any fields of the Module. If all conditions matched then Fields Color feature added to the Module which is selected in Step 1(Select Module)',
  'LBL_FIELDS_COLOR_ANY_CONDITIONS_MESSAGE' => 'Specify conditions of any fields of the Module. If any condition matched then Fields Color feature added to the Module which is selected in Step 1(Select Module)',
  'LBL_CONDITIONAL_OPERATOR' => 'Conditional Operator :',
  'LBL_AND' => 'AND',
  'LBL_OR' => 'OR',
  'LBL_ADD_CONDITIONS' => 'Add Conditions',
  'LBL_MODULE_PATH' => 'Selected Module',
  'LBL_FIELD' => 'Field',
  'LBL_OPERATOR' => 'Operator',
  'LBL_VALUE_TYPE' => 'Value Type',
  'LBL_VALUE' => 'Value',
  'LBL_DOES_NOT_CONTAINS' => 'Does Not Contains',
  'LBL_IS_EMPTY' => 'Is Empty',
  'LBL_IS_NOT_EMPTY' => 'Is Not Empty',
  'LBL_TODAY' => 'Today',
  'LBL_TOMORROW' => 'Tomorrow',
  'LBL_YESTERDAY' => 'Yesterday',
  'LBL_IS_IN_LAST_7_DAYS' => 'Is in Last 7 Days',
  'LBL_IS_IN_LAST_30_DAYS' => 'Is in Last 30 Days',
  'LBL_IS_IN_LAST_60_DAYS' => 'Is in Last 60 Days',
  'LBL_IS_IN_LAST_90_DAYS' => 'Is in Last 90 Days',
  'LBL_IS_IN_LAST_120_DAYS' => 'Is in Last 120 Days',
  'LBL_IS_IN_THIS_WEEK' => 'Is in this Week',
  'LBL_IS_IN_THE_LAST_WEEK' => 'Is in the Last Week',
  'LBL_IS_IN_THIS_MONTH' => 'Is in this Month',
  'LBL_IS_IN_THE_LAST_MONTH' => 'Is in the Last Month',
  'LBL_FIELDS_COLOR_NAME_EMPTY_ERROR' => 'Please Enter Fields Color Name.',
  'LBL_SELECT_MODULE_EMPTY_ERROR' => 'Please Select Module.',
  'LBL_FIELDS_COLOR_EMPTY_CONDITIONS_VALIDATION' => 'Please add atleast one Condition.',
  'LBL_REQUIRED_FIELD_VALIDATION' => 'Please Select/Enter Required Fields.',
  'LBL_FIELDS_COLOR_ACTIVATED' => 'Fields Color Feature Activated Successfully!!!',
  'LBL_FIELDS_COLOR_DEACTIVATED' => 'Fields Color Feature Deactivated Successfully!!!',
  'LBL_SELECT_FIELDS_TO_COLOR_EMPTY_ERROR' => 'Please Select Fields to Color.',
  'LBL_SELECT_FIELDS_TO_COLOR_INFO_MESSAGE' => 'Select the fields for which you want to apply the font and background color in Field Value based on Condition match.',
  'LBL_COLOR_THE_LABEL_INFO_MESSAGE' => 'Select Yes if you want to apply the font color in Field Label based on Condition match.',
);