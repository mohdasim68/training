...
//header('Location: index.php?module=LiveHelperChat&action=license');
    global $sugar_version;
    if(preg_match( "/^6.*/", $sugar_version)) {
        echo "
            <script>
            document.location = 'index.php?module=LiveHelperChat&action=license';
            </script>"
        ;
    } else {
        echo "
            ...
            window.parent.SUGAR.App.sync({callback: function(){
                app.router.navigate('#bwc/index.php?module=LiveHelperChat&action=license', {trigger:true});
            }});
            </script>"
        ;
    }
