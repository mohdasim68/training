 ...
 * 
 ********************************************************************************/
if(!class_exists('VIFieldsColorOutfittersLicense')) {
    class VIFieldsColorOutfittersLicense{
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = VIFieldsColorOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate() {
            ...
            $validated = VIFieldsColorOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('VIFieldsColorOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('VIFieldsColorOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = VIFieldsColorOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private static function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = VIFieldsColorOutfittersLicense::getKey($module);
